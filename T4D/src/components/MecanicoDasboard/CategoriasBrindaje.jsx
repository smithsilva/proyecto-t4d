    ...
    <div style={{ padding: "20px", width: "100%", boxSizing: "border-box" }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button
          ...
          style={{ background: "#B89B6A", color: "#000", fontWeight: "600", fontSize: "13px", borderRadius: "8px" }}
      ...
      <div className="row g-2 mb-3">
        <div className="col-md-4">
          <div className="p-3 rounded-4 shadow-sm d-flex justify-content-between align-items-start"
                  ...
                  <td>
                    <div className="d-flex gap-2">
                      <button
                        ...
                        style={{ width: "30px", height: "30px", background: "#f3f4f6", border: "none", borderRadius: "6px" }}
                      ...
                      <button
                        className="btn btn-sm d-flex align-items-center justify-content-center"
                        style={{ width: "30px", height: "30px", background: "#fee2e2", border: "none", borderRadius: "6px" }}
