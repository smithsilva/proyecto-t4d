  ...
  return (
    <div className="p-5" style={{ marginTop: "1px", background: "#fff", minHeight: "100vh" }}>
      ...
      <div className="card p-3 rounded-4 shadow-sm">
        ...
        {cargando ? (
          <div className="text-center py-4" style={{ color: "#6b7280", fontSize: 13 }}>Cargando métodos de pago...</div>
        ) : (
          <table className="table align-middle">
            <thead>
              <tr>
                {["ID", "Nombre", "Tipo", "Online", "Descripción", "Acciones"].map((col) => (
            ...
            <tbody>
              {metodosFiltrados.map((m) => (
                <tr key={m.id_metodo_pago}>
                  <td style={{ fontSize: 13, color: "#374151" }}>#{m.id_metodo_pago}</td>
                  <td>
                  ...
                  <td>
                    <span style={{
                      background: m.permite_online ? "#B89B6A" : "#374151",
                      color: m.permite_online ? "#000" : "#fff",
                  ...
                  <td>
                    <div className="d-flex gap-2">
                      <Eye size={18} style={{ cursor: "pointer", color: "#374151" }} onClick={() => setVerMetodo(m)} />
                      <Pencil size={18} style={{ cursor: "pointer", color: "#B89B6A" }} onClick={() => abrirEditar(m)} />
                      <Trash2 size={18} style={{ cursor: "pointer", color: "#ef4444" }} onClick={() => setEliminarId(m.id_metodo_pago)} />
                    </div>
                  </td>
                </tr>
              ))}
      ...
      {verMetodo && (
        <div className="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
          style={{ background: "rgba(0,0,0,0.5)", zIndex: 1000 }} onClick={() => setVerMetodo(null)}>
      ...
      {editarMetodo && (
        <div className="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
          style={{ background: "rgba(0,0,0,0.5)", zIndex: 1000 }} onClick={() => setEditarMetodo(null)}>
          <div className="bg-white p-4 rounded-4 shadow"
            style={{ width: 420, maxHeight: "90vh", overflowY: "auto", position: "relative" }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="d-flex gap-2">
              ...
              <button onClick={guardarEdicion} className="btn rounded-pill btn-sm flex-fill"
                style={{ backgroundColor: "#B89B6A", color: "#000", border: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
      ...
      {mostrarAgregar && (
        <div className="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
          style={{ background: "rgba(0,0,0,0.5)", zIndex: 1000 }} onClick={() => setMostrarAgregar(false)}>
          <div className="bg-white p-4 rounded-4 shadow"
            style={{ width: 420, maxHeight: "90vh", overflowY: "auto", position: "relative" }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="d-flex gap-2">
              ...
              <button onClick={guardarNuevo} className="btn rounded-pill btn-sm flex-fill"
                style={{ backgroundColor: "#B89B6A", color: "#000", border: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
      ...
      {eliminarId && (
        <div className="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
          style={{ background: "rgba(0,0,0,0.5)", zIndex: 1000 }} onClick={() => setEliminarId(null)}>
            ...
            <div className="text-center">
              ...
              <div className="d-flex gap-2">
                ...
                <button onClick={confirmarEliminar} className="btn flex-fill"
                  style={{ background: "#ef4444", color: "#fff", border: "none", fontWeight: 600 }}>Eliminar</button>
              </div>
            </div>
          </div>
        </div>
